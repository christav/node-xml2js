...
(function() {
  var Stream, events, isEmpty, sax, util,
  ...
  exports.Parser = (function(_super) {
    ...
    Parser.prototype.reset = function() {
      ...
      err = false;
      this.saxParser.on("error", function(error) {
        if (!err) {
          err = true;
    ...
    Parser.prototype.createStream = function(cb) {
      var stream,
        _this = this;
      ...
      stream.write = function(data, encoding) {
        return _this.saxParser.write(data, encoding);
      };
      stream.end = function(data, encoding) {
        if (arguments.length > 0) {
          _this.saxParser.write(data, encoding);
        }
        return _this.saxParser.end;
      };
      return stream;
    };
  ...
  exports.streamParser = function(opts, cb) {
    var parser;

    parser = new exports.Parser(opts);
    return parser.createStream(cb);
  };
